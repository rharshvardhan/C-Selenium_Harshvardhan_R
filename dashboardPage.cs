    ...
    public class DashboardPage
    {
       private readonly IWebDriver driver;
        ...
        public static readonly By LogoutLink = By.XPath("//a[text()='Logout']");
         public static readonly By PIMModule = By.XPath("//span[text()='PIM']/parent::a");
        public static readonly By AddEmployee = By.XPath("//button[contains(.,'Add')]");
        public static readonly By firstName = By.XPath("//input[@name='firstName']");
        public static readonly By lastName = By.XPath("//input[@name='lastName']");
        ...
        public static readonly By saveBtn = By.XPath("//button[normalize-space()='Save']");
        public static readonly By time = By.XPath("//span[text()='Time']");
        public static readonly By tinesheetInput = By.XPath("//input[@placeholder='Type for hints...']");
